          ...
          <div class="flex justify-between h-16">
            <div class="flex">
              ...
              <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                ...
                >
                  <i
                    class="fas fa-home text-blue-500"
                    style="font-size: 25px; width: 30px; height: 30px"
                  ></i>
                  Dashboard
                </NavLink>
                ...
                >
                  <i
                    class="fas fa-capsules text-green-500"
                    style="font-size: 25px; width: 30px; height: 30px"
                  ></i>
                  Medicines
                </NavLink>
                ...
                <NavLink
                  :href="route('admin.admininventory.index')"
                  :active="route().current('admin.admininventory.index')"
                >
                  <i
                    class="fas fa-box text-purple-500"
                    style="font-size: 25px; width: 30px; height: 30px"
                  ></i>
                  Inventory
                </NavLink>
                ...
                >
                  <i
                    class="fas fa-comments text-orange-500"
                    style="font-size: 25px; width: 30px; height: 30px"
                  ></i>
                  Chat
                </NavLink>
                ...
                >
                  <i
                    class="fas fa-users text-teal-500"
                    style="font-size: 25px; width: 30px; height: 30px"
                  ></i>
                  Users
                </NavLink>
