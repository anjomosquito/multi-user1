                        ...
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <NavLink :href="route('admin.medicines.index')"
                                    ...
                                    <svg width="45px" height="45px" viewBox="0 0 1024 1024" class="icon" version="1.1"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M776 239l-48-13 48-13 13-49 13 49 48 13-48 13-13 48-13-48zM824 292l-19-5 19-4 4-19 5 19 18 4-18 5-5 18-4-18z"
                                            fill="#FDCD60" />
                                        <path d="M184 562l-21-5 21-5 5-21 5 21 21 5-21 5-5 21-5-21z" fill="#FDCD60" />
                                        <path d="M212 255m-9 0a9 9 0 1 0 18 0 9 9 0 1 0-18 0Z" fill="#5546CB" />
                                        <path
                                        ...
                                        <path
                                            ...
                                            fill="#FDCD60" />
                                        <path d="M723 677V460H308v217zM459 559h49v-49h20v49h49v20h-49v49h-20v-49h-49z"
                                            fill="#FFFFFF" />
                                        <path
                                        ...
                                        <path
                                            ...
                                            fill="#FDCD60" />
                                        <path d="M724 893a27 27 0 0 0 37-37zM695 790l-11-11a27 27 0 0 0-38 38l11 11z"
                                            fill="#AFBCF3" />
                                        <path
